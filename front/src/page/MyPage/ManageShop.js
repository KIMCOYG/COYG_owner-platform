...
const shopname = [{ name: '정호네 꽃가게' }, { name: '유진이네 햄버거' }];

const SelectShop = () => {
  return (
    <select>
      {shopname.map((shopname) => (
        <option key={shopname.name} value={shopname.name}>
          {shopname.name}
        </option>
      ))}
    </select>
