        ...
        lists.map(e => (
            <Form onSubmit={handleSubmit} id="registEvent">
                <Form.Group controlId="formShopName">
                    ...
                    <Form.Control type="input" defaultValue={e.shop.name} disabled></Form.Control>
                </Form.Group>

                <Form.Group controlId="formEventName">
                    <Form.Label>이벤트명</Form.Label>
                    <Form.Control type="input" defaultValue={e.event.name}></Form.Control>
                </Form.Group>

                <Form.Label>이벤트 기간</Form.Label>
                <Form.Row className="align-items-center">
                    {/*TODO: 2021.04.18 date의 format에 따라서 값 불러오기. 실패시 react-datePicker 사용 -sunbo*/}
                    <Form.Group as={Col} controlId="formEventStart" value={e.start_datetime}>
                        <Form.Label>시작일</Form.Label>
                        <Form.Control type="date" value="2021-04-03"/>
                    </Form.Group>
                    <Form.Group as={Col} controlId="formEventEnd" value={e.end_datetime}>
