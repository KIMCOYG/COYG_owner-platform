...
export const getCategoriesImage = createPromiseThunk(GET_POSTS, postsAPI.getCategoriesImage);

export const getCategoryListsById = createPromiseThunkById(GET_POST, postsAPI.getCategoryListsById)
export const getScrapEventsById = createPromiseThunkById(GET_POST, postsAPI.getScrapEventsById);
...
export const getMyShopsById = createPromiseThunkById(GET_POST, postsAPI.getMyShopsById);
export const getUserById = createPromiseThunkById(GET_POST, postsAPI.getUserById);
export const getOwnerEventListById = createPromiseThunkById(GET_POST, postsAPI.getOwnerEventListById);
